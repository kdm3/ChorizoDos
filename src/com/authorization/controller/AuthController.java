...
public class AuthController {
	 ...
	 * 
	 * import com.wrapper.spotify.Api; import
	 * com.wrapper.spotify.models.AuthorizationCodeCredentials;
	 * 
	 * @Controller public class AuthController { public static final String
	 * clientId = "f51aba0d64d444d3b91fa0654e5f6e7f"; public static final String
	 * clientSecret = "363647ac2286445c84f7d4687e8144fc"; public static final
	 * String redirectURI = "http://localhost:8080/ChorizoDos/callback";
	 * 
	 * 
	 * @RequestMapping(value="/init") public ModelAndView initAuth() { final Api
	 ...
	 * 
	 * // pass a user-identifiable string using state variable final String
	 ...
	 * return new ModelAndView("redirect:" + authorizeURL); }
	 * 
	 * @RequestMapping(value = "/callback") public ModelAndView
	 * myCallback(@RequestParam("code") String code, @RequestParam("state")
	 * String state, Model model) {
	 * 
	 * final Api api =
	 * Api.builder().clientId(clientId).clientSecret(clientSecret).redirectURI(
	 * redirectURI).build(); String token = null; String rtoken =null; try {
	 * final AuthorizationCodeCredentials authorizationCodeCredentials =
	 * api.authorizationCodeGrant(code).build() .get();
	 * 
	 * System.out.println("State: " + state); System.out.println(
	 * "Successfully retrieved an access token! " +
	 * authorizationCodeCredentials.getAccessToken()); System.out
	 * .println("The access token expires in " +
	 ...
	 * api.setRefreshToken(authorizationCodeCredentials.getRefreshToken());
	 * 
	 * token = authorizationCodeCredentials.getAccessToken(); rtoken =
	 * authorizationCodeCredentials.getRefreshToken();
	 * System.out.println("This is the Token:" + token);
	 * System.out.println("This is the Refresh Token:" + rtoken); } catch
	 * (Exception e) { System.out.println(e.toString()); }
	 * 
	 * model.addAttribute("token", token); model.addAttribute("rtoken", rtoken);
	 * 
	 * // return "/spotify/initAuth"; return new ModelAndView("/initAuth"); }
	 * 
	 * }
	 */